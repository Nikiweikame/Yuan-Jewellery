...
const IGArray = ref([
  {
    url: "https://www.instagram.com/p/CsQRLk4vm3R/",
    image: "./src/assets/IG_01.jpeg",
  },
  {
    url: "https://www.instagram.com/p/Cr-6YhPvUkr/",
    image: "./src/assets/IG_02.jpeg",
  },
  {
    url: "https://www.instagram.com/p/Crzeyznv3r8/",
    image: "./src/assets/IG_03.jpeg",
  },
  {
    url: "https://www.instagram.com/p/CrkAthYvXZL/",
    image: "./src/assets/IG_04.jpeg",
  },
]);
</script>

<template>
  <div class="IG-link" id="IG">
    <p class="IG-link__title">
      OUR INSTAGRAM
      <svg
        width="40"
        height="40"
    ...
    <div class="row gy-3">
      <div class="col-12 col-lg-3" v-for="data in IGArray">
        <a :href="data.url"><img :src="data.image" alt="" /></a>
      </div>
    </div>
  </div>
</template>
