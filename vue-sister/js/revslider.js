  ...
  jQuery.extend(!0, b, {
    ...
    prepareSingleCaption: function (a) {
      ...
      var m =
        void 0 === d.visibility
          ? "oon"
          : s(d.visibility, e)[e.forcedWinRange] ||
            s(d.visibility, e) ||
            "ooon";
      if (
        ("off" === m ||
        ...
        (o = s(n.data("ww"), e)[e.curWinRange] || s(n.data("ww"), e) || "auto"),
          (p =
            s(n.data("hh"), e)[e.curWinRange] || s(n.data("hh"), e) || "auto");
      ...
      if (
        ...
        var o =
            s(c.data("videowidth"), e)[e.curWinRange] ||
            s(c.data("videowidth"), e) ||
            "auto",
          p =
            s(c.data("videoheight"), e)[e.curWinRange] ||
            s(c.data("videoheight"), e) ||
            "auto";
        !jQuery.isNumeric(o) && o.indexOf("%") > 0
          ? (p = parseFloat(p) * e.bh + "px")
          : ((o = parseFloat(o) * e.bw + "px"),
            (p = parseFloat(p) * e.bh + "px")),
    ...
    buildFullTimeLine: function (a) {
      var h,
        ...
        j = n();
      if (
        ((h = e.timelines[d._slideid].layers[d._id]),
        ...
        if (
          ...
          if (
            ...
            void 0 != d.hoveranim.anim.color &&
              ((o.anim.fill = d.hoveranim.anim.color),
          ...
          c.hover(
            function (a) {
              ...
              (h.forcehover = i.force),
                j &&
                  ((h.hovertimelines.item = punchgs.TweenLite.to(
                    d,
                    i.speed / 1e3,
                    h.hoveranim.anim
                  )),
                  (h.hoverzIndex ||
                    (h.hoveranim.anim && h.hoveranim.anim.zIndex)) &&
                    ((h.basiczindex =
                      void 0 === h.basiczindex
                        ? h.cssobj.zIndex
                        : h.basiczindex),
                    (h.hoverzIndex =
                      void 0 === h.hoverzIndex
                        ? h.hoveranim.anim.zIndex
                        : h.hoverzIndex),
                    (h.inhoverinanimation = !0),
                    0 === i.speed && (h.inhoverinanimation = !1),
                    (h.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                      h._pw,
                      i.speed / 1e3,
                      { overwrite: "auto", zIndex: h.hoverzIndex }
                    )),
                    h.hovertimelines.pwhoveranim.eventCallback(
                      "onComplete",
                      function (a) {
                  ...
                  g.svg &&
                    (h.hovertimelines.svghoveranim = punchgs.TweenLite.to(
                      [g.svg, g.svg.find("path")],
                      i.speed / 1e3,
                      h.hoversvg.anim
                    )),
                  (h.hoveredstatus = !0));
            ...
            function (a) {
              ...
              j &&
                ...
                (h.hovertimelines.item = punchgs.TweenLite.to(
                  d,
                  i.speed / 1e3,
                  jQuery.extend(!0, {}, h._gsTransformTo)
                )),
                0 == i.speed && (h.inhoveroutanimation = !1),
                h.hovertimelines.item.eventCallback(
                  "onComplete",
                  function (a) {
                ...
                void 0 !== h.hovertimelines.pwhoveranim &&
                  (h.hovertimelines.pwhoveranim = punchgs.TweenLite.to(
                    h._pw,
                    i.speed / 1e3,
                    { overwrite: "auto", zIndex: h.basiczindex }
                  )),
                g.svg &&
        ...
        for (var p = 0; p < d.frames.length; p++)
          if (p !== d.hoverframeindex) {
            var r =
              p === d.inframeindex
                ? "frame_0"
                : p === d.outframeindex || "frame_999" === d.frames[p].frame
                ? "frame_999"
                : "frame_" + p;
            (d.frames[p].framename = r),
              (h[r] = {}),
              (h[r].timeline = new punchgs.TimelineLite({ align: "normal" }));
            var s = d.frames[p].delay,
              v =
                (d.triggered_startstatus,
                void 0 !== s
                  ? jQuery.inArray(s, ["slideenter", "bytrigger", "wait"]) >= 0
                    ? s
                    : parseInt(s, 0) / 1e3
                  : "wait");
            void 0 !== h.firstslide &&
              "frame_0" === r &&
              (i.addLabel("slide_" + h.firstslide + "_pause", 0),
              i.addPause("slide_" + h.firstslide + "_pause"),
              i.addLabel("slide_" + h.firstslide, "+=0.005")),
              void 0 !== h.lastslide &&
                "frame_999" === r &&
                (i.addLabel("slide_" + h.lastslide + "_pause", "+=0.01"),
                i.addPause("slide_" + h.lastslide + "_pause"),
                i.addLabel("slide_" + h.lastslide, "+=0.005")),
              jQuery.isNumeric(v)
                ? i.addLabel(r, "+=" + v)
                : (i.addLabel("pause_" + p, "+=0.01"),
                  i.addPause("pause_" + p),
                  i.addLabel(r, "+=0.01")),
    ...
    createFrameOnTimeline: function (a) {
      var c = a.caption,
        ...
        w = !1;
      if (
        ((u = void 0 === u ? "forward" : u),
        d.hoverframeindex !== -1 && d.hoverframeindex == s && (s -= 1),
        (n.content = new punchgs.TimelineLite({ align: "normal" })),
        (n.mask = new punchgs.TimelineLite({ align: "normal" })),
        void 0 === f.vars.id && (f.vars.id = Math.round(1e5 * Math.random())),
        "column" === d._nctype &&
          (f.add(punchgs.TweenLite.set(d._cbgc_man, { display: "block" }), e),
          f.add(punchgs.TweenLite.set(d._cbgc_auto, { display: "none" }), e)),
        d.splittext && 0 === g)
      ) {
      ...
      void 0 !== d.mySplitText &&
        t &&
        t.match(/chars|words|lines/g) &&
        ((l = d.mySplitText[t]), (w = !0));
      var D,
        E,
        y =
          g !== d.outframeindex
            ? q(j(), d.frames[g].to, void 0, w, l.length - 1)
            : void 0 !== d.frames[g].to &&
              null === d.frames[g].to.match(/auto:auto/g)
            ? q(m(), d.frames[g].to, 1 == k.sdir, w, l.length - 1)
            : q(
                m(),
                d.frames[d.inframeindex].from,
                0 == k.sdir,
                w,
                l.length - 1
              ),
        B =
          void 0 !== d.frames[g].from
            ? q(y, d.frames[d.inframeindex].from, 1 == k.sdir, w, l.length - 1)
            : void 0,
      ...
      if (
        ...
        void 0 !== B &&
          ((B.anim.ease =
            void 0 === d.frames[g].ease
              ...
              : d.frames[g].ease),
          (B.speed =
            void 0 === d.frames[g].speed ? B.speed : d.frames[g].speed),
          (B.anim.x =
            B.anim.x * k.bw ||
            p(B.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal")),
          (B.anim.y =
            B.anim.y * k.bw ||
            p(B.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical"))),
        void 0 !== y &&
          ((y.anim.ease =
            void 0 === d.frames[g].ease
              ? punchgs.Power1.easeInOut
              : d.frames[g].ease),
          (y.speed =
            void 0 === d.frames[g].speed ? y.speed : d.frames[g].speed),
          (y.anim.x =
            y.anim.x * k.bw ||
            p(y.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal")),
          (y.anim.y =
            y.anim.y * k.bw ||
            p(y.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical"))),
        c.data("iframes") &&
          f.add(
        ...
        g === d.outframeindex &&
          (d.frames[g].to && d.frames[g].to.match(/auto:auto/g),
          (y.speed =
            void 0 === d.frames[g].speed || "inherit" === d.frames[g].speed
              ? d.frames[d.inframeindex].speed
              : d.frames[g].speed),
          (y.anim.ease =
            void 0 === d.frames[g].ease || "inherit" === d.frames[g].ease
        ...
        if (l != c) {
          ...
          f.add(punchgs.TweenLite.set(c, y.anim), e),
            ...
            void 0 !== F["-webkit-filter"] &&
              (y.anim["-webkit-filter"] = F["-webkit-filter"]);
        }
      ...
      if (0 !== g || a.fromcurrentstate)
        if ("block" === d._sfx_out && g === d.outframeindex)
          f.add(n.content.staggerTo(l, 0.001, { autoAlpha: 0, delay: G }), e),
            f.add(
              n.content.staggerTo(l, y.speed / 1e3 / 2 - 0.001, {
                x: 0,
                delay: G,
              }),
              e + "+=0.001"
        ...
        var L = { from: i(B.anim), to: i(y.anim) };
        for (var M in l) {
      ...
      return (
        void 0 === E ||
          ...
          (E.anim.x =
            E.anim.x * k.bw ||
            p(E.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal")),
          (E.anim.y =
            E.anim.y * k.bw ||
            p(E.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical"))),
        (0 === g && D && D !== !1 && !a.fromcurrentstate) ||
        (0 === g && a.ignorefirstframe)
          ? ((E = new Object()),
            (E.anim = new Object()),
            ...
            D &&
              ...
              ((D.anim.x =
                D.anim.x * k.bw ||
                p(D.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal")),
              (D.anim.y =
                D.anim.y * k.bw ||
                p(D.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")),
              (D.anim.overflow = "hidden")))
          : 0 === g && f.add(n.mask.set(d._mw, { overflow: "visible" }), e),
        void 0 !== D && void 0 !== E && D !== !1 && E !== !1
          ? f.add(n.mask.fromTo(d._mw, B.speed / 1e3, D.anim, E.anim, C), e)
          : void 0 !== E &&
            E !== !1 &&
            f.add(n.mask.to(d._mw, y.speed / 1e3, E.anim, C), e),
        f.addLabel(e + "_end"),
        d._gsTransformTo &&
          g === s &&
          d.hoveredstatus &&
    ...
    h = function (a, b) {
      ...
      switch (b) {
        ...
        case "middletoedge":
          ...
          c.push(e);
          for (var d = 0; d < e; d++)
            f >= 0 && c.push(f), h <= a && c.push(h), f--, h++;
          break;
        case "edgetomiddle":
          for (var f = a, h = 0, d = 0; d <= Math.floor(a / 2); d++)
            c.push(f), h < f && c.push(h), f--, h++;
      }
      return c;
    },
    i = function (a) {
          ...
          jQuery.each(g, function (a, b) {
            ...
            c &&
              ...
              void 0 != j &&
                ((j = j.replace(/\(R\)/, "")),
                ("rotationX" != i && "rX" != i) ||
                  (f.anim.rotationX = o(j, f.anim.rotationX, d, e, "deg")),
                ("rotationY" != i && "rY" != i) ||
                  (f.anim.rotationY = o(j, f.anim.rotationY, d, e, "deg")),
                ("rotationZ" != i && "rZ" != i) ||
                  (f.anim.rotation = o(j, f.anim.rotationZ, d, e, "deg")),
                ("scaleX" != i && "sX" != i) ||
                  (f.anim.scaleX = o(j, f.anim.scaleX, d, e)),
                ("scaleY" != i && "sY" != i) ||
                  (f.anim.scaleY = o(j, f.anim.scaleY, d, e)),
                ("opacity" != i && "o" != i) ||
                  (f.anim.opacity = o(j, f.anim.opacity, d, e)),
                "fb" == i &&
                  (h =
                    "" === h
                ...
                ("skewX" != i && "skX" != i) ||
                  (f.anim.skewX = o(j, f.anim.skewX, d, e)),
                ("skewY" != i && "skY" != i) ||
                  (f.anim.skewY = o(j, f.anim.skewY, d, e)),
  ...
  if (tpj("#rev_slider_1078_1").revolution == undefined) {
    ...
    revapi1078 = tpj("#rev_slider_1078_1")
      ...
      .revolution({
        ...
        responsiveLevels: [1240, 1024, 778, 0], // 原本480
        visibilityLevels: [1240, 1024, 778, 0], // 原本480
        gridwidth: [1240, 1024, 778, 0], // 原本480
        gridheight: [700, 700, 600, 0], // 原本500
        lazyType: "none",
        parallax: {
          type: "mouse",
          origo: "slidercenter",
